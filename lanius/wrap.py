...
def wrap(text,                  # string or unicode to be wrapped
         ...
         frenchspacing = True,  # Single space instead of double after periods
         measure = len,         # how to measure the length of a word
         overpenalty = 3000,    # penalize long lines by overpen*(len-target)
         nlinepenalty = 900,    # penalize more lines than optimal
